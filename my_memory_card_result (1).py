...
questions_list = [] 
questions_list.append(Question('Кто живет в Германии', 'Немцы', 'Германцы', 'Поляки', 'Русы'))
...
questions_list.append(Question('как раньше называл Республику Тыва', 'Урянхайский край', 'Якутия', 'Хакасия', 'Тувинский край'))
questions_list.append(Question('Что больше глубина Марианской впадины или горы Эверест(Джамалунгма)', 'Глубина Марианской впадины больше высоты Эвереста', 'Высота Эвереста больше глубины Марианской впадины', 'Не знаю', 'Их высоты равны'))
#####
...
def next_question():
    ...
    window.total = window.total + 1 # переходим к следующему вопросу
